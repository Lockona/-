...
#define LV_DISP_ROT_MAX_BUF  (30U * 1024U)
...
#if LV_ENABLE_GC != 0
#  define LV_GC_INCLUDE "rtthread.h"                           /*Include Garbage Collector related things*/
#  define LV_MEM_CUSTOM_REALLOC   rt_realloc          /*Wrapper to realloc*/
 ...
 */
#define LV_FONT_CUSTOM_DECLARE 		LV_FONT_DECLARE(test_font_16)\
																	LV_FONT_DECLARE(test_font_24)\
																	LV_FONT_DECLARE(ebrimabd_font)\
																	LV_FONT_DECLARE(admin_fornt)
...
#  define LV_SPRINTF_INCLUDE <rtthread.h>
